...
export const VIDEOS = [
  { id: '10m',      title: '10 Million',             cat: 'Music Video',    role: 'DP / Editor',                     year: '2026', desc: 'Shot, lit, and edited solo.',    yt: '3frfHolmYkE',  did: '10A2uzDxrEEgx-6tiS3M_qbhAq72dglZt', feat: true, objectPosition: 'center' },
  { id: 'black',    title: 'Black Stuff',             cat: 'Music Video',    role: 'DP / Editor',                     year: '2025', desc: 'Dark aesthetics, deep narrative weight.',                    yt: 'NqcGtFr95oM',  did: '1KHdETMZDHqrRzkL7Ook-61KHxFwcGnKB', feat: true, objectPosition: 'center' },
  { id: 'intv',     title: 'Live Interview Show',     cat: 'Live Multi-Cam', role: 'Camera Op / Director',            year: '2025', desc: 'Directing multiple camera operators in real time.',  yt: 'rctvfSJsO9Y', did: '1A7dgksrR-9KJ6TyxfO6Ch3TOc2bqbL0t', feat: false, objectPosition: 'center' },
  ...
  { id: 'cook',     title: 'Live Cooking Demo',       cat: 'Live Multi-Cam', role: 'Camera Op / Switcher',            year: '2025', desc: 'Real-time switching, no second takes.',                              yt: 'R2IZKAHYmME', did: '13fmSRFNiGZl2b57-cd0qVnjcPx9IDUUZ', feat: false, objectPosition: 'center' },
  { id: 'brief',    title: 'The Briefcase',           cat: 'Short Film',     role: 'Writer / DP',                     year: '2024', desc: 'Crime thriller. Two couriers, one briefcase.',    yt: 'pUZkiH74yTU',  did: '1EM1AVe-50e6IMKL2m8teeakg6aSL3ctr', feat: true, objectPosition: 'center' },
  ...
  { id: 'altitude', title: 'The Pursuit of Altitude', cat: 'Documentary',    role: 'DP / Editor',                     year: '2024', desc: 'Visual storytelling through landscape and movement.',  yt: 'wHwXBw2xk5M', did: '1-bPAYnQROhT9awRMEBWuDCGSw04CtBgE', feat: false, objectPosition: 'center' },
  ...
  { id: 'tiktok',   title: 'TikTok Addiction',        cat: 'Doc Teaser',     role: 'Director / Editor',               year: '2024', desc: 'Our relationship with infinite scroll.',                                                  yt: 'KQHjrvuthYE', did: '1o61DVHh8QhTYWKSOQOvs9P4kEoZQqygI', feat: false, objectPosition: 'center' },
  { id: 'fraud',    title: 'Fraud',                   cat: 'Doc Teaser',     role: 'Director / Editor',               year: '2024', desc: 'How fraud operates in plain sight.',                                        yt: 'E6rydhe1PAY', did: '10AfFlmGp1qbqI_9BKSQnYfyTi7o_SFbp', feat: false, objectPosition: 'center' },
];
